...
var LogoContainer = function () {
    return (jsx("div", __assign({ style: { width: 200, height: 'auto', display: 'grid', placeItems: 'center', margin: 'auto' } }, { children: jsx("img", { src: 'https://res.cloudinary.com/dungnqhe151250/image/upload/v1619186953/logo/Logo2_xnkzp1.svg', alt: 'logo' }, void 0) }), void 0));
};

var InAppLogo = function () {
    return (jsx("div", __assign({ style: { paddingTop: 12,
            width: 200,
            height: 100,
            display: 'grid',
            placeItems: 'center' } }, { children: jsx("img", { alt: 'in-app-logo', width: 200, height: 60, src: 'https://res.cloudinary.com/dungnqhe151250/image/upload/v1619186953/logo/No_target_line_hlhrqn.svg' }, void 0) }), void 0));
};
...
var SelectLocale = function () {
    ...
    return (jsxs(Select, __assign({ defaultValue: "vi", size: 'small', onChange: onLocaleChange }, { children: [jsx(Option, __assign({ value: "vi" }, { children: "VI" }), void 0),
            jsx(Option, __assign({ value: "en" }, { children: "EN" }), void 0)] }), void 0));
};
...
export { InAppLogo, LogoContainer, SelectLocale, changeLocale, usePasswordRule, useTrans, useUsernameRule };
