...
require('@ant-design/icons/es/components/Context');
...
var DownOutlined__default = /*#__PURE__*/_interopDefaultLegacy(DownOutlined);
var LoadingOutlined__default = /*#__PURE__*/_interopDefaultLegacy(LoadingOutlined);
var CheckOutlined__default = /*#__PURE__*/_interopDefaultLegacy(CheckOutlined);
var CloseOutlined__default = /*#__PURE__*/_interopDefaultLegacy(CloseOutlined);
var CloseCircleFilled__default = /*#__PURE__*/_interopDefaultLegacy(CloseCircleFilled);
var SearchOutlined__default = /*#__PURE__*/_interopDefaultLegacy(SearchOutlined);
var ExclamationCircleFilled__default = /*#__PURE__*/_interopDefaultLegacy(ExclamationCircleFilled);
var CheckCircleFilled__default = /*#__PURE__*/_interopDefaultLegacy(CheckCircleFilled);
var InfoCircleFilled__default = /*#__PURE__*/_interopDefaultLegacy(InfoCircleFilled);
...
var Logger = function () {
  ...
  _createClass$2(Logger, [{
    ...
    value: function create(moduleName) {
      return new Logger(this.logger, _objectSpread$7({}, {
...
var ResourceStore = function (_EventEmitter) {
  ...
  function ResourceStore(data) {
    ...
    _this = _possibleConstructorReturn$1(this, _getPrototypeOf$2(ResourceStore).call(this));
  ...
  _createClass$2(ResourceStore, [{
    ...
    value: function addResourceBundle(lng, ns, resources, deep, overwrite) {
      ...
      if (deep) {
        ...
        pack = _objectSpread$7({}, pack, resources);
      }
    ...
    value: function getResourceBundle(lng, ns) {
      ...
      if (this.options.compatibilityAPI === 'v1') return _objectSpread$7({}, {}, this.getResource(lng, ns));
...
var Translator = function (_EventEmitter) {
  ...
  function Translator(services) {
    ...
    _this = _possibleConstructorReturn$1(this, _getPrototypeOf$2(Translator).call(this));
  ...
  _createClass$2(Translator, [{
    ...
    value: function translate(keys, options, lastKey) {
      ...
      if (handleAsObjectInI18nFormat && res && handleAsObject && noObject.indexOf(resType) < 0 && !(typeof joinArrays === 'string' && resType === '[object Array]')) {
        ...
        if (keySeparator) {
          ...
          for (var m in res) {
            if (Object.prototype.hasOwnProperty.call(res, m)) {
              ...
              copy[m] = this.translate(deepKey, _objectSpread$7({}, options, {
                joinArrays: false,
                ns: namespaces
              }));
        ...
        if (usedKey || usedDefault || updateMissing) {
          ...
          if (keySeparator) {
            var fk = this.resolve(key, _objectSpread$7({}, options, {
              keySeparator: false
            }));
    ...
    value: function extendTranslation(res, key, options, resolved, lastKey) {
      ...
      if (this.i18nFormat && this.i18nFormat.parse) {
        ...
        if (options.interpolation) this.interpolator.init(_objectSpread$7({}, options, {
          interpolation: _objectSpread$7({}, this.options.interpolation, options.interpolation)
        }));
        ...
        if (this.options.interpolation.defaultVariables) data = _objectSpread$7({}, this.options.interpolation.defaultVariables, data);
      ...
      if (res !== undefined && res !== null && postProcessorNames && postProcessorNames.length && options.applyPostProcessor !== false) {
        res = postProcessor.handle(postProcessorNames, res, key, this.options && this.options.postProcessPassResolved ? _objectSpread$7({
...
var Interpolator = function () {
  ...
  _createClass$2(Interpolator, [{
    ...
    value: function interpolate(str, data, lng, options) {
      ...
      var handleFormat = function handleFormat(key) {
        if (key.indexOf(_this.formatSeparator) < 0) {
          ...
          return _this.alwaysFormat ? _this.format(path, undefined, lng, _objectSpread$7({}, options, data, {
        ...
        return _this.format(getPathWithDefaults(data, defaultData, k), f, lng, _objectSpread$7({}, options, data, {
          interpolationkey: k
        }));
      };
    ...
    value: function nest(str, fc) {
      ...
      var clonedOptions = _objectSpread$7({}, options);
      ...
      function handleHasOptions(key, inheritedOptions) {
        ...
        try {
          ...
          if (inheritedOptions) clonedOptions = _objectSpread$7({}, inheritedOptions, clonedOptions);
        } catch (e) {
      ...
      while (match = this.nestingRegexp.exec(str)) {
        ...
        if (doReduce) {
          value = formatters.reduce(function (v, f) {
            return _this2.format(v, f, options.lng, _objectSpread$7({}, options, {
...
var Connector = function (_EventEmitter) {
  ...
  function Connector(backend, store, services) {
    ...
    _this = _possibleConstructorReturn$1(this, _getPrototypeOf$2(Connector).call(this));
  ...
  _createClass$2(Connector, [{
    ...
    value: function saveMissing(languages, namespace, key, fallbackValue, isUpdate) {
      ...
      if (this.backend && this.backend.create) {
        this.backend.create(languages, namespace, key, fallbackValue, null, _objectSpread$7({}, options, {
          isUpdate: isUpdate
        }));
      }
...
function get$1() {
  return {
    ...
    overloadTranslationOptionHandler: function handle(args) {
      var ret = {};
      if (_typeof$5(args[1]) === 'object') ret = args[1];
...
var I18n = function (_EventEmitter) {
  ...
  function I18n() {
    ...
    _this = _possibleConstructorReturn$1(this, _getPrototypeOf$2(I18n).call(this));
  ...
  _createClass$2(I18n, [{
    ...
    value: function init() {
      ...
      this.options = _objectSpread$7({}, get$1(), this.options, transformOptions(options));
...
function _objectSpread$6(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys$8(Object(source), true).forEach(function (key) { _defineProperty$5(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys$8(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
var defaultOptions = {
...
function useTranslation(ns) {
  ...
  var i18nOptions = _objectSpread$5(_objectSpread$5(_objectSpread$5({}, getDefaults$1()), i18n.options.react), props);
...
var Username$1 = "Tên tài khoản";
var Password$1 = "Mật khẩu";
var Fullname$1 = "Họ và tên";
var Email$1 = "Email";
var Logout$1 = "Đăng xuất";
var Dashboard$1 = "Bảng tin";
var Questions$1 = "Danh sách câu hỏi";
var Session$1 = "Session";
var Setting$1 = "Cài đặt";
var Matching$1 = "Matching";
var Join$1 = "Tham gia";
var Updated$1 = "Đã cập nhật";
var Gender$1 = "Giới tính";
var Male$1 = "Nam";
var Female$1 = "Nữ";
var Address$1 = "Địa chỉ";
var Achievement$1 = "Thành tựu";
var Skill$1 = "Kỹ năng";
var Bio$1 = "Giới thiệu";
var Github$1 = "Github";
var Update$1 = "Cập nhật";
var Avatar$1 = "Ảnh đại diện";
var Upload$1 = "Tải lên";
var Title$1 = "Tiêu đề";
var Content$1 = "Nội dung";
var Point$1 = "Point";
var Create$1 = "Tạo";
var Status$1 = "Trạng thái";
var Balance$1 = "Số dư";
var Guide$1 = "Hướng dẫn";
var Mentee$1 = "Mentee";
var From$1 = "Từ";
var New$1 = "Mới";
var Done$1 = "Đã xong";
...
var vi = {
	...
	"The terms and conditions": "Điều khoản và chính sách",
	"Login successfully": "Đăng nhập thành công",
	"Can't login": "Không thể đăng nhập",
	"Please enter your username": "Vui lòng điền tên tài khoản",
	"Please enter your password": "Vui lòng nhập mật khẩu",
	"Register successfully": "Đăng kí thành công",
	"Can't register": "Không thể đăng kí",
	"Invalid email": "Email không hợp lệ",
	"Please enter your email": "Vui lòng nhập email",
	"Please re enter your password": "Vui lòng nhập lại mật khẩu",
	"Password need to match": "Hai mật khẩu cần giống nhau",
	"Should accept agreement": "Bạn phải đồng ý với điều khoản",
	Logout: Logout$1,
	"Authenticating...": "Đang xác thực...",
	"Your notification": "Thông báo của bạn",
	...
	Join: Join$1,
	"Can't share screen!": "Không thể chia sẻ màn hình!",
	"Share Screen": "Chia sẻ màn hình",
	"Stop Share Screen": "Dừng chia sẻ",
	"You can only upload JPG/PNG file!": "Bạn chỉ có thể tải lên tập tin JPG/PNG!",
	"Image must smaller than 2MB!": "Tập tin phải nhỏ hơn 1MB!",
	Updated: Updated$1,
	...
	Title: Title$1,
	Content: Content$1,
	"Please select the skill": "Vui lòng chọn kỹ năng",
	Point: Point$1,
	Create: Create$1,
	Status: Status$1,
	Balance: Balance$1,
	"This month questions": "Câu hỏi tháng này",
	"Favorite Mentor": "Mentor yêu thích",
	Guide: Guide$1,
	...
	Mentee: Mentee$1,
	From: From$1,
	"No matching question found": "Không tìm thấy câu hỏi phù hợp",
	New: New$1,
	Done: Done$1,
	"Real-time Collaborative Editor": "Real-time Collaborative Editor",
...
var en = {
	...
	Title: Title,
	Content: Content,
	"Please select the skill": "Please select the skill",
	Point: Point,
	Create: Create,
	Status: Status,
	Balance: Balance,
	"This month questions": "This month questions",
	"Favorite Mentor": "Favorite Mentor",
	Guide: Guide,
	"Ask a question for help": "Ask a question for help",
	"Your questions": "Your questions",
	"Use your mouse then click onto the card and swipe to right to choose, left to ignore": "Use your mouse then click onto the card and swipe to right to choose, left to ignore",
	"Setting your account": "Setting your account",
	"Selected this question": "Selected this question",
	Mentee: Mentee,
	From: From,
	"No matching question found": "No matching question found",
	New: New,
	Done: Done,
	"Real-time Collaborative Editor": "Real-time Collaborative Editor",
...
var LogoContainer = function () {
    return (jsxRuntime.jsx("div", __assign({ style: { width: 200, height: 'auto', display: 'grid', placeItems: 'center', margin: 'auto' } }, { children: jsxRuntime.jsx("img", { src: 'https://res.cloudinary.com/dungnqhe151250/image/upload/v1619186953/logo/Logo2_xnkzp1.svg', alt: 'logo' }, void 0) }), void 0));
};
...
function pickAttrs(props) {
  ...
  if (ariaOnly === false) {
    ...
    mergedConfig = _objectSpread$3({}, ariaOnly);
  }
...
var Filler = /*#__PURE__*/React__namespace.forwardRef(function (_ref, ref) {
  ...
  if (offset !== undefined) {
    ...
    innerStyle = _objectSpread$2(_objectSpread$2({}, innerStyle), {}, {
...
function RawList(props, ref) {
  ...
  var _useDiffItem = useDiffItem(mergedData, getKey),
      _useDiffItem2 = _slicedToArray$1(_useDiffItem, 1),
      diffItem = _useDiffItem2[0];

  diffItemRef.current = diffItem; // ================================ Height ================================

  var _useHeights = useHeights(getKey, null, null),
      _useHeights2 = _slicedToArray$1(_useHeights, 4),
  ...
  if (height) {
    componentStyle = _objectSpread$1(_defineProperty$1({}, fullHeight ? 'height' : 'maxHeight', height), ScrollStyle);
...
var getLabeledValue = function getLabeledValue(value, _ref2) {
  ...
  if (prevValItem && _typeof$5(prevValItem) === 'object' && 'label' in prevValItem) {
...
function fillOptionsWithMissingValue(options, value, optionLabelProp, labelInValue) {
  ...
  values.forEach(function (item) {
    ...
    if (!optionValues.has(val)) {
      ...
      cloneOptions.push(labelInValue ? (_ref6 = {}, _defineProperty$5(_ref6, optionLabelProp, item.label), _defineProperty$5(_ref6, "value", val), _ref6) : {
        value: val
      });
    }
  });
...
var SelectSelector = function SelectSelector(props) {
  ...
  function defaultRenderSelector(content, itemDisabled, closable, onClose) {
    return /*#__PURE__*/React__namespace.createElement("span", {
      className: classnames("".concat(selectionPrefixCls, "-item"), _defineProperty$5({}, "".concat(selectionPrefixCls, "-item-disabled"), itemDisabled))
...
var Selector = function Selector(props, ref) {
  ...
  var _useLock = useLock(0),
      _useLock2 = _slicedToArray$4(_useLock, 2),
...
function wrapKeyToObject(key) {
  ...
  if (key && _typeof$5(key) === 'object' && 'key' in key) {
    keyObj = key;
  } else {
    keyObj = {
      key: key
  ...
  var CSSMotionList = /*#__PURE__*/function (_React$Component) {
    ...
    _createClass$2(CSSMotionList, [{
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React__namespace.createElement(Component, Object.assign({}, restProps), keyEntities.map(function (_ref2) {
          var status = _ref2.status,
              eventProps = _objectWithoutProperties$1(_ref2, ["status"]);

          var visible = status === STATUS_ADD || status === STATUS_KEEP;
          return /*#__PURE__*/React__namespace.createElement(CSSMotion$1, Object.assign({}, motionProps, {
            key: eventProps.key,
            visible: visible,
...
var PopupInner = /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
  ...
  var _useStretchStyle = useStretchStyle(stretch),
      _useStretchStyle2 = _slicedToArray$4(_useStretchStyle, 2),
  ...
  var _useVisibleStatus = useVisibleStatus(visible, doMeasure),
      _useVisibleStatus2 = _slicedToArray$4(_useVisibleStatus, 2),
...
var SelectTrigger = function SelectTrigger(props, ref) {
  ...
  return /*#__PURE__*/React__namespace.createElement(Trigger, _extends$1({}, restProps, {
    ...
    popupClassName: classnames(dropdownClassName, _defineProperty$5({}, "".concat(dropdownPrefixCls, "-empty"), empty)),
...
function generateSelector(config) {
  ...
  function Select(props, ref) {
    ...
    var _useDelayReset = useDelayReset(),
        _useDelayReset2 = _slicedToArray$4(_useDelayReset, 3),
    ...
    var _useMemo = React.useMemo(function () {
      return toInnerValue(mergedValue, {
        ...
        _useMemo2 = _slicedToArray$4(_useMemo, 2),
    ...
    if (mergedShowArrow) {
      arrowNode = /*#__PURE__*/React__namespace.createElement(TransBtn, {
        className: classnames("".concat(prefixCls, "-arrow"), _defineProperty$5({}, "".concat(prefixCls, "-arrow-loading"), loading)),
...
function warningProps(props) {
  ...
  if (value !== undefined && value !== null) {
    ...
    warningOnce(!labelInValue || values.every(function (val) {
      return _typeof$5(val) === 'object' && ('key' in val || 'value' in val);
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { _defineProperty$4(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
...
function isObject(obj) {
  return _typeof$5(obj) === 'object' && obj !== null && Object.getPrototypeOf(obj) === Object.prototype;
}
/**
...
function isSimilar(source, target) {
  ...
  if (!source || !target || _typeof$5(source) !== 'object' || _typeof$5(target) !== 'object') {
    return false;
  }
...
function convertMessages(messages, name, rule, messageVariables) {
  ...
  function fillTemplate(source) {
    ...
    Object.keys(source).forEach(function (ruleName) {
      ...
      } else if (value && _typeof$5(value) === 'object') {
        target[ruleName] = {};
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            validator = new AsyncValidator(_defineProperty$5({}, name, [cloneRule]));
            messages = convertMessages(options.validateMessages, name, cloneRule, messageVariables);
            validator.messages(messages);
            result = [];
            _context2.prev = 7;
            _context2.next = 10;
            return Promise.resolve(validator.validate(_defineProperty$5({}, name, value), _objectSpread2$1({}, options)));
...
function normalize(namePath) {
  return namePath.map(function (cell) {
    return "".concat(_typeof$5(cell), ":").concat(cell);
  }) // Magic split
  .join(SPLIT);
}
/**
        ...
        return callback({
          key: cells.map(function (cell) {
            var _cell$match = cell.match(/^([^:]*):(.*)$/),
                _cell$match2 = _slicedToArray$4(_cell$match, 3),
                type = _cell$match2[1],
                unit = _cell$match2[2];
  ...
  return /*#__PURE__*/React__namespace.createElement(FormContext.Provider, {
    value: _objectSpread2$1(_objectSpread2$1({}, formContext), {}, {
      ...
      registerForm: function registerForm(name, form) {
        if (name) {
          formsRef.current = _objectSpread2$1(_objectSpread2$1({}, formsRef.current), {}, _defineProperty$5({}, name, form));
        }
...
var Form = function Form(_ref, ref) {
  ...
  var _useForm = useForm(form),
      _useForm2 = _slicedToArray$4(_useForm, 1),
...
var Empty = function Empty(_a) {
  ...
  return /*#__PURE__*/React__namespace.createElement(LocaleReceiver, {
    ...
    return /*#__PURE__*/React__namespace.createElement("div", _extends$1({
      className: classnames(prefixCls, (_classNames = {}, _defineProperty$5(_classNames, "".concat(prefixCls, "-normal"), image === simpleEmptyImg), _defineProperty$5(_classNames, "".concat(prefixCls, "-rtl"), direction === 'rtl'), _classNames), className)
  ...
  _createClass$2(Notice, [{
    ...
    value: function render() {
      ...
      var node = /*#__PURE__*/React__namespace.createElement("div", _extends$1({
        className: classnames(componentClass, className, _defineProperty$5({}, "".concat(componentClass, "-closable"), closable)),
        style: style,
...
function createUseMessage(getRcNotificationInstance, getRCNoticeProps) {
  var useMessage = function useMessage() {
    ...
    var _useRCNotification = useNotification(proxy),
        _useRCNotification2 = _slicedToArray$4(_useRCNotification, 2),
...
function getRCNoticeProps(args, prefixCls) {
  ...
  var messageClass = classnames("".concat(prefixCls, "-custom-content"), (_classNames = {}, _defineProperty$5(_classNames, "".concat(prefixCls, "-").concat(args.type), args.type), _defineProperty$5(_classNames, "".concat(prefixCls, "-rtl"), rtl === true), _classNames));
  return {
    key: args.key,
    duration: duration,
    style: args.style || {},
...
function getIcons(_ref) {
  ...
  if (!clearIcon) {
    mergedClearIcon = /*#__PURE__*/React__namespace.createElement(CloseCircleFilled__default['default'], null);
  } // Arrow item icon
  ...
  if (suffixIcon !== undefined) {
    ...
    mergedSuffixIcon = /*#__PURE__*/React__namespace.createElement(LoadingOutlined__default['default'], {
      spin: true
    });
  } else {
    ...
    mergedSuffixIcon = function mergedSuffixIcon(_ref2) {
      ...
      if (open && showSearch) {
        return /*#__PURE__*/React__namespace.createElement(SearchOutlined__default['default'], {
          className: iconCls
        });
      }

      return /*#__PURE__*/React__namespace.createElement(DownOutlined__default['default'], {
        className: iconCls
      });
    };
  } // Checked item icon
  ...
  if (menuItemSelectedIcon !== undefined) {
    ...
    mergedItemIcon = /*#__PURE__*/React__namespace.createElement(CheckOutlined__default['default'], null);
  } else {
    mergedItemIcon = null;
  }
  ...
  if (removeIcon !== undefined) {
    ...
    mergedRemoveIcon = /*#__PURE__*/React__namespace.createElement(CloseOutlined__default['default'], null);
  }
...
var InternalSelect = function InternalSelect(_a, ref) {
  ...
  var rcSelectRtlDropDownClassName = classnames(dropdownClassName, _defineProperty$5({}, "".concat(prefixCls, "-dropdown-").concat(direction), direction === 'rtl'));
  var mergedSize = customizeSize || size;
  var mergedClassName = classnames((_classNames2 = {}, _defineProperty$5(_classNames2, "".concat(prefixCls, "-lg"), mergedSize === 'large'), _defineProperty$5(_classNames2, "".concat(prefixCls, "-sm"), mergedSize === 'small'), _defineProperty$5(_classNames2, "".concat(prefixCls, "-rtl"), direction === 'rtl'), _defineProperty$5(_classNames2, "".concat(prefixCls, "-borderless"), !bordered), _classNames2), className);
...
var SelectLocale = function () {
    ...
    var onLocaleChange = function (value) {
        i18n.changeLanguage(value).then(function () {
            api.success(t("Changed language to") + t("" + value));
        });
    };
    return (jsxRuntime.jsxs(Select, __assign({ defaultValue: "vi", size: 'small', onChange: onLocaleChange }, { children: [jsxRuntime.jsx(Option, __assign({ value: "vi" }, { children: "VI" }), void 0),
            jsxRuntime.jsx(Option, __assign({ value: "en" }, { children: "EN" }), void 0)] }), void 0));
};

var usePasswordRule = function () {
    ...
    return [
        ...
        },
        {
            ...
            message: t('The password must contain at least 1 lowercase alphabetical character'),
        },
        {
        ...
        {
            pattern: new RegExp('(?=.*[A-Z])'),
            message: t('The password must contain at least 1 uppercase alphabetical character'),
        },
        {
        ...
        {
            pattern: new RegExp('(?=.*[!@#$%^&*])'),
            message: t('The password must contain at least one special character'),
        },
        {
...
exports.useFullnameRule = useFullnameRule;
